  ...
  return (
    <Screen eyebrow="Account" title="Profile" withNav>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
        ...
        <MenuRow icon="📄" label="Document center" hint="Expiry tracking and re-upload" onClick={() => navigate('/documents')} />
        <MenuRow icon="🗺️" label="Demand heatmap" hint="See where bookings are hot" onClick={() => navigate('/heatmap')} />
