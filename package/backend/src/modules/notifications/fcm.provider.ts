...
const TEMPLATE_COPY: Record<string, { title: string; body: string }> = {
  ...
  pickup_verified: { title: 'Pickup verified', body: 'Your trip is now in progress.' },
  trip_completed: { title: 'Trip completed', body: 'Your trip has been completed.' },
  new_offer: { title: 'New trip offer', body: 'You have a new delivery offer nearby.' },
  new_ride_offer: { title: 'New ride offer', body: 'You have a new passenger ride offer nearby.' },
