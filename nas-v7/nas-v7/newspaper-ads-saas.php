...
function nas_portal_no_shell_slugs(): array {
    return array_merge( nas_portal_dashboard_slugs(), [
        'book-newspaper-ad', // wizard has its own masthead
    ] );
}
...
function nas_portal_should_wrap_shell(): bool {
    ...
    if ( in_array( $slug, nas_portal_no_shell_slugs(), true ) ) {
        return false;
    }
    return true;
}
