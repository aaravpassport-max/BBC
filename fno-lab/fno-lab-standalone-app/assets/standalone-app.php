...
<div id="fno-root">
  ...
  <div class="card card-accent-primary fno-chart-section" id="priceChartSection" style="margin-bottom:14px">
    ...
    <div class="fno-chart-toolbar" style="display:flex;gap:6px;align-items:center;margin-bottom:6px;flex-wrap:wrap">
      ...
      <button type="button" class="btn" id="chartCustomIndicatorBtn" style="padding:3px 8px;font-size:11px" title="FNO Formula or Pine Script subset — import .fnoind.json or .pine">📜 Scripts</button>
    ...
    <div id="chartCustomIndicatorPanel" style="display:none;margin-bottom:8px;padding:8px;background:#0f172a;border:1px solid #334155;border-radius:8px;font-size:11px">
      ...
      <div style="font-size:10px;color:#64748b;margin-bottom:6px;line-height:1.45"><strong>Works:</strong> <code>indicator()</code>, inputs, one <code>plot()</code>, <code>ta.ema/sma/rsi/highest/lowest/vwap</code>, math, same-chart <code>request.security(syminfo.tickerid, &quot;D&quot;, close)</code>. <strong>Does not run:</strong> strategies, <code>import</code>, <code>if</code>/<code>for</code>, or plots that <em>depend on</em> <code>array.*</code> — extra array/var lines that are not needed for your <code>plot()</code> may be <strong>auto-removed</strong> on compile. Use <strong>Load sample EMA</strong> or Formula <code>ema(close, 14)</code>.</div>
      ...
      <div style="display:flex;flex-wrap:wrap;gap:6px;align-items:center;margin-bottom:6px">
        ...
        <input type="file" id="chartCustomIndImportFile" accept=".json,.fnoind.json,.pine,application/json,text/plain" style="display:none">
...
<script>
<?php include __DIR__ . '/chart-pine-compiler.js'; ?>
</script>
<script>
