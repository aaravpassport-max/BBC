...
assert.ok(coreSrc.includes('function formatLedgerWhenIST'), 'ledger must format times in IST');
assert.ok(coreSrc.includes('function normalizeTradeTimestampMs'), 'ledger must normalize second/ms timestamps');
